...
export default function Info() {
  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <Link href="/routes/about">   <button className="flex mx-auto mt-20 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">About us</button></Link>
  </div>
</section>
    </div>
  )
