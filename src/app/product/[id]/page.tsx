...
// // const cclicked = ()=> alert('added to cart')
// //   if (!product) {
...
// //            <br /> <button onClick={cclicked} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-center">Add To Cart</button>
...
//     alert(`Item added to cart. Total items in cart: ${cartCount + 1}`);  // Show alert with updated count
//   };
...
//                 <span className="title-font font-medium text-2xl text-gray-900 relative left-8"><Increment /> </span>
//                 <br />
//                 <button onClick={handleAddToCart} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-center">Add To Cart</button>
//                 <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
//                   <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
//                     <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"></path>
//                   </svg>
...
export default function ProductDetail({ params }: ProductDetailProps) {
  ...
  return (
    <div>
      <div className="bg-amber-950">
        {/* Pass cartCount to Header to display updated cart count */}
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="des my-[30px]">
            <div className="text p-5">
              <h1 className="text-black text-[40px] font-serif">Description</h1>
              <p>Dive into the charm of nature with our exquisite flower bouquet...</p>
            </div>
          </div>
        </div>
        <Contact />
